...
export default function Sidebar() {
  return (
    <div className="group absolute left-0 z-50 flex flex-col h-full justify-between items-stretch py-10 w-12 hover:w-36 duration-100 transition-all bg-secondary-background">
