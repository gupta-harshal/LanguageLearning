...
const Spaceship = ({ children }: SpaceshipProps) => {
  return (
    <div
      className="relative mx-auto h-[220px] w-[min(720px,92vw)] animate-pulse [animation-duration:2.2s] [filter:drop-shadow(0_0_22px_rgba(96,165,250,0.45))]"
      aria-hidden="true"
    >
      ...
      <div className="absolute left-[calc(50%-74px)] top-[62px] h-[56px] w-[26px] -skew-x-[14deg] rounded-[14px_8px_18px_14px] border border-sky-200/45 bg-[linear-gradient(180deg,rgba(125,211,252,0.95)_0%,rgba(59,130,246,0.9)_34%,rgba(15,23,42,0.98)_100%)] shadow-[0_0_14px_rgba(96,165,250,0.18)]" />
      <div className="absolute right-[calc(50%-74px)] top-[62px] h-[56px] w-[26px] skew-x-[14deg] rounded-[8px_14px_14px_18px] border border-sky-200/45 bg-[linear-gradient(180deg,rgba(125,211,252,0.95)_0%,rgba(59,130,246,0.9)_34%,rgba(15,23,42,0.98)_100%)] shadow-[0_0_14px_rgba(96,165,250,0.18)]" />
