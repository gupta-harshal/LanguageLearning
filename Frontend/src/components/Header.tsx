    ...
    return (
        <header className="absolute top-0 left-0 w-full h-20 z-50 flex items-center justify-between px-6 bg-primary-background/40 backdrop-blur-md shadow-lg border-b border-primary-foreground/10">
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    onClick={toggleTheme}
                    className="hidden md:inline-flex items-center gap-2 rounded-full border border-primary-foreground/15 bg-primary-background/40 px-4 py-2 text-sm font-bold text-primary-font-color shadow-md transition-transform hover:scale-105"
